...
export class DataBase1649295068915 implements MigrationInterface {
    name = 'DataBase1649295068915'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`aluno\` (\`matricula\` varchar(9) NOT NULL, \`email\` varchar(255) NOT NULL, \`isBolsista\` tinyint NOT NULL, \`nome\` varchar(255) NOT NULL, \`situacao\` enum ('Reguar', 'Em risco', 'Jubilado') NOT NULL DEFAULT 'Reguar', \`rendimento\` float NOT NULL, \`cursoId\` int NULL, UNIQUE INDEX \`REL_78a69c2e65e9c3fd20f1a9ce72\` (\`cursoId\`), PRIMARY KEY (\`matricula\`)) ENGINE=InnoDB`);
